...
// LoadCertPool returns the system certificate pool, optionally extended with the
// PEM bundle found at caFile. An empty caFile returns the system pool unchanged.
...
// LoadX509KeyPair loads the client certificate and key used for mTLS authentication.
...
// GetOkmsIDFromCert extracts the OVHcloud KMS instance ID embedded as an otherName
// ("okms.domain:<uuid>") in the certificate's Subject Alternative Name extension.
